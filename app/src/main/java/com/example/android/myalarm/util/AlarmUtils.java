package com.example.android.myalarm.util;
...
import com.example.android.myalarm.data.DatabaseHelper;
import com.example.android.myalarm.model.Alarm;

import java.text.SimpleDateFormat;
import java.util.ArrayList;
import java.util.Locale;

import static com.example.android.myalarm.data.DatabaseHelper.COL_FRI;
import static com.example.android.myalarm.data.DatabaseHelper.COL_IS_ENABLED;
import static com.example.android.myalarm.data.DatabaseHelper.COL_LABEL;
import static com.example.android.myalarm.data.DatabaseHelper.COL_MON;
import static com.example.android.myalarm.data.DatabaseHelper.COL_SAT;
import static com.example.android.myalarm.data.DatabaseHelper.COL_SUN;
import static com.example.android.myalarm.data.DatabaseHelper.COL_THURS;
import static com.example.android.myalarm.data.DatabaseHelper.COL_TIME;
import static com.example.android.myalarm.data.DatabaseHelper.COL_TUES;
import static com.example.android.myalarm.data.DatabaseHelper.COL_WED;
import static com.example.android.myalarm.data.DatabaseHelper._ID;
